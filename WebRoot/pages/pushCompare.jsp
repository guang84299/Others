...
$("#compare").click(function(){
	...
	var urll = "<%out.print(basePath); %>pushCompare_list?pushId=" + pushId + "&index=0";
	location.href = urll;
});
...
$("#delete").click(function()
{
	...
	var pushId = $("#pushId").val();
	var urll = "<%out.print(basePath); %>pushCompare_deleteUserPush?pushId=";
	urll = urll + pushId + "&id="+id;
...
var pushId = $("#pushId").val();
a_1.href = "pushCompare_list?pushId=" + pushId + "&index=" + (parseInt(index)-1);
a_2.href = "pushCompare_list?pushId=" + pushId + "&index=" + (parseInt(index)+1);
}
