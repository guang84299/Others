	...
	<tbody>
		<s:iterator value="list" var="user">
			<tr>
				...
				<td align="center"><s:date name="#user.createDate" format="yyyy-MM-dd HH:mm:ss" /></td>
			</tr>
		</s:iterator>
	</tbody>
</table>
...
a_1.href = "session_list?index=" + (parseInt(index)-1);
a_2.href = "session_list?index=" + (parseInt(index)+1);	
}
